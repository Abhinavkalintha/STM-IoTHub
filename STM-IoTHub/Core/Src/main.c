...
struct bme68x_dev bme;              // Sensor device structure
...
/* USER CODE BEGIN Header_StartRelayControlTask */
/**
...
void StartRelayControlTask(void *argument)
{
  ...
  /* USER CODE END StartRelayControlTask */
}

/* USER CODE BEGIN Header_StartEnergyTask */
/**
* @brief Function implementing the EnergyTask thread.
* @param argument: Not used
* @retval None
*/
/* USER CODE END Header_StartEnergyTask */
